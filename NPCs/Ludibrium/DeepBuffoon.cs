...
namespace TerraStory.NPCs.Ludibrium
{
	...
	public class DeepBuffoon : ModNPC
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Deep Buffoon"); // Automatic from .lang files
		...
		public override void SetDefaults() 
		{
			...
			npc.value = 1f;
			npc.HitSound = mod.GetLegacySoundSlot(SoundType.NPCHit, "Sounds/NPCHit/DeepBuffoonHit");
			npc.DeathSound = mod.GetLegacySoundSlot(SoundType.NPCKilled, "Sounds/NPCKilled/DeepBuffoonDie");
