...
namespace TerraStory.NPCs.Ludibrium
{
	...
	public class PinkTeddy : ModNPC
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("PinkTeddy"); // Automatic from .lang files
		...
		public override void SetDefaults() 
		{
			...
			npc.value = 1f;
			npc.HitSound = mod.GetLegacySoundSlot(SoundType.NPCHit, "Sounds/NPCHit/PinkTeddyHit");
			npc.DeathSound = mod.GetLegacySoundSlot(SoundType.NPCKilled, "Sounds/NPCKilled/PinkTeddyDie");
