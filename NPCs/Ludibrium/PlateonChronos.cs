...
namespace TerraStory.NPCs.Ludibrium
{
	...
	public class PlateonChronos : ModNPC
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("PlateonChronos"); // Automatic from .lang files
		...
		public override void SetDefaults() 
		{
			...
			npc.value = 1f;
			npc.HitSound = mod.GetLegacySoundSlot(SoundType.NPCHit, "Sounds/NPCHit/PlateonChronosHit");
			npc.DeathSound = mod.GetLegacySoundSlot(SoundType.NPCKilled, "Sounds/NPCKilled/PlateonChronosDie");
