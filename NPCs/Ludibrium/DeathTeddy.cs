...
namespace TerraStory.NPCs.Ludibrium
{
	...
	public class DeathTeddy : ModNPC
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Death Teddy"); // Automatic from .lang files
		...
		public override void SetDefaults() 
		{
			...
			npc.value = 1f;
			npc.HitSound = mod.GetLegacySoundSlot(SoundType.NPCHit, "Sounds/NPCHit/DeathTeddyHit");
			npc.DeathSound = mod.GetLegacySoundSlot(SoundType.NPCKilled, "Sounds/NPCKilled/DeathTeddyDie");
		...
		{
			if (Main.rand.NextFloat() < .50f) // 20% chance
