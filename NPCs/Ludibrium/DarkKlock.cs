...
namespace TerraStory.NPCs.Ludibrium
{
	...
	public class DarkKlock : ModNPC
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("DarkKlock"); // Automatic from .lang files
			Main.npcFrameCount[npc.type] = 5;
        }
		
		public override void SetDefaults() 
		{
			npc.width = 128;  // hitbox
			npc.height = 120;
			npc.scale = 0.90f;
			npc.aiStyle = 3;
			npc.damage = 22;
			...
			npc.value = 1f;
			npc.HitSound = mod.GetLegacySoundSlot(SoundType.NPCHit, "Sounds/NPCHit/DarkKlockHit");
			npc.DeathSound = mod.GetLegacySoundSlot(SoundType.NPCKilled, "Sounds/NPCKilled/DarkKlockDie");
		...
		{
			MasksHelper.DrawNPCGlowMask(spriteBatch, npc, mod.GetTexture("NPCs/GlowMasks/DarkKlock_Glow"));
		}
