...
namespace TerraStory.NPCs.Ludibrium
{
	...
	public class Buffy : ModNPC
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Buffy"); // Automatic from .lang files
		...
		public override void SetDefaults() 
		{
			...
			npc.value = 1f;
			npc.HitSound = mod.GetLegacySoundSlot(SoundType.NPCHit, "Sounds/NPCHit/BuffyHit");
			npc.DeathSound = mod.GetLegacySoundSlot(SoundType.NPCKilled, "Sounds/NPCKilled/BuffyDie");
