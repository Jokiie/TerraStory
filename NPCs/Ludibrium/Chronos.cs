...
namespace TerraStory.NPCs.Ludibrium
{
	...
	public class Chronos : ModNPC
	{
		...
		{
			DisplayName.SetDefault("Chronos"); // Automatic from .lang files
		...
		public override void SetDefaults() 
		{
			...
			npc.value = 1f;
			npc.HitSound = mod.GetLegacySoundSlot(SoundType.NPCHit, "Sounds/NPCHit/ChronosHit");
			npc.DeathSound = mod.GetLegacySoundSlot(SoundType.NPCKilled, "Sounds/NPCKilled/ChronosDie");
