...
namespace TerraStory.NPCs.Ludibrium
{
	...
	public class DrummingBunny : ModNPC
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Drumming Bunny"); // Automatic from .lang files
		...
		public override void SetDefaults() 
		{
			...
			npc.value = 1f;
			npc.HitSound = mod.GetLegacySoundSlot(SoundType.NPCHit, "Sounds/NPCHit/DrummingBunnyHit");
			npc.DeathSound = mod.GetLegacySoundSlot(SoundType.NPCKilled, "Sounds/NPCKilled/DrummingBunnyDie");
