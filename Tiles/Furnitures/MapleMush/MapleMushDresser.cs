...
{
	public class MapleMushDresser : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.SetDefault("Maple mushroom dresser");
			AddMapEntry(new Color(255, 165, 0), name);
			dustType = 124;
			disableSmartCursor = true;
			adjTiles = new int[] { TileID.Dressers };
			dresser = "Maple mushroom dresser";
			dresserDrop = ItemType<Items.Placeable.MapleMush.MapleMushDresserItem>();
		}
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.showItemIcon2 = ItemType<Items.Placeable.MapleMush.MapleMushDresserItem>();
