...
{
	public class MapleMushClock : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.SetDefault("Maple mushroom clock");
		...
		{
			Item.NewItem(i * 16, j * 16, 48, 32, ItemType<Items.Placeable.MapleMush.MapleMushClockItem>());
		}
	}
}