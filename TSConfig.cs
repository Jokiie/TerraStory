...
namespace TerraStory
{
    public class TSConfig
    {
        ...
        public static string ConfigPath => Main.SavePath + Path.DirectorySeparatorChar + "TerraStory_Settings.json";
        ...
        public static string StatsPath => Main.SavePath + Path.DirectorySeparatorChar + "TerraStory_Stats.json";
