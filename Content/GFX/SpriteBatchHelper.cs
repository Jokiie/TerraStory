...
namespace TerraStory.Content.GFX
{
    public static class SpriteBatchHelper
    {
        ...
        public static void Draw(this SpriteBatch spriteBatch, Texture2D[] blackNumeral, Texture2D texture, Vector2 position, Color color, float scale)
        {
            spriteBatch.Draw(texture, position, null, color, 0f, Vector2.Zero, scale, SpriteEffects.None, 0f);
        }

        public static void Draw(this SpriteBatch spriteBatch, Texture2D texture, Vector2 position, System.Drawing.Rectangle rectangle, Rectangle? sourceRectangle, Color color, float scale)
        {
