...
{
	public class LudiWorldMethods
	{
		public static void RoundHill(int X, int Y, int Xmult, int Ymult, int strength, bool initialplace, ushort type)
		{
			if (initialplace)
			{
				LudiWorldMethods.TileRunner(X, Y, (double)strength * 5, 1, type, true, 0f, 0f, true, true);
			}
			for (int rotation2 = 0; rotation2 < 350; rotation2++)
			{
				...
				LudiWorldMethods.TileRunner(X + DistX, Y + DistY, (double)strength, 1, type, true, 0f, 0f, true, true);
			}
		}
		...
		public static void RoundHill2(int X, int Y, int Xmult, int Ymult, int strength, bool initialplace, ushort type)
		{
			if (initialplace)
			{
				LudiWorldMethods.TileRunner(X, Y, (double)strength * 5, 1, type, false, 0f, 0f, true, true);
			}
			for (int rotation2 = 0; rotation2 < 350; rotation2++)
			{
				int DistX = (int)(0 - (Math.Sin(rotation2) * Xmult));
				int DistY = (int)(0 - (Math.Cos(rotation2) * Ymult));
				LudiWorldMethods.TileRunner(X + DistX, Y + DistY, (double)strength, 1, type, false, 0f, 0f, true, true);
			}
		}
		...
		public static void Island(int X, int Y, int Xsize, float slope, ushort tile)
		{
			for (int xAxis = X; xAxis < X + Xsize; xAxis++)
			{
				...
				{
					LudiWorldMethods.TileRunner(xAxis, Y + I, Xsize / 5, 1, tile, false, 0f, 0f, true, true);
				}
				LudiWorldMethods.TileRunner(xAxis, Y, Xsize / 5, 1, tile, false, 0f, 0f, true, true);
				//   if (Main.rand.Next(55) == 0)
				//   {
				//      LudiWorldMethods.RoundHill(xAxis, Y - 7, 22, 14, 15, true, tile);
		...
		public static void makeTemple(int x, int y)
		{
			...
			for (int num41 = 0; num41 < num2; num41++)
			{
				...
				while (flag2)
				{
					...
					vector = LudiWorldMethods.templePather(vector, num42, num43);
				...
				if (num41 < num2 - 1)
				{
					if (Main.rand.Next(3) != 0)
					{
						...
						while (flag2)
						{
							...
							vector = LudiWorldMethods.templePather(vector, num45, num46);
					...
					else
					{
						...
						while (flag2)
						{
							...
							vector = LudiWorldMethods.templePather(vector, num50, num51);
			...
			for (int num57 = num52; num57 < num53; num57++)
			{
				...
				{
					LudiWorldMethods.outerTempled(num57, num58);
				}
			}
			for (int num59 = num53; num59 >= num52; num59--)
			{
				...
				{
					LudiWorldMethods.outerTempled(num59, num60);
				}
			}
			for (int num61 = num54; num61 < num55; num61++)
			{
				...
				{
					LudiWorldMethods.outerTempled(num62, num61);
				}
			}
			for (int num63 = num55; num63 >= num54; num63--)
			{
				...
				{
					LudiWorldMethods.outerTempled(num64, num63);
				}
			}
			num3 = -num4;
			...
			for (int num81 = num52; num81 < num53; num81++)
			{
				...
				{
					LudiWorldMethods.templeCleaner(num81, num82);
				}
			}
			for (int num83 = num55; num83 >= num54; num83--)
			{
				...
				{
					LudiWorldMethods.templeCleaner(num84, num83);
				}
			}
