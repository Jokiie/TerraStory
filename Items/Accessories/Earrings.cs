...
namespace TerraStory.Items.Accessories
{
	...
	public abstract class Earrings : ModItem
	{
		...
		public override bool CanEquipAccessory(Player player, int slot)
		{
			...
			if (slot < 10) // This allows the accessory to equip in vanity slots with no reservations
			{
				...
				int index = FindDifferentEquippedEarrings().index;
				if (index != -1)
				{
					return slot == index;
				}
		...
		public override void ModifyTooltips(List<TooltipLine> tooltips)
		{
			...
			Item accessory = FindDifferentEquippedEarrings().accessory;
			if (accessory != null)
			{
				tooltips.Add(new TooltipLine(mod, "Swap", "Right click to swap with '" + accessory.Name + "'! Only 1 pair of earrings can be worn at a time. ")
				{
		...
		public override bool CanRightClick()
		{
			...
			if (FindDifferentEquippedEarrings().accessory != null)
			{
				return true;
			}
		...
		public override void RightClick(Player player)
		{
			...
			var (index, accessory) = FindDifferentEquippedEarrings();
			if (accessory != null)
			{
		...
		protected (int index, Item accessory) FindDifferentEquippedEarrings()
		{
			int maxAccessoryIndex = 5 + Main.LocalPlayer.extraAccessorySlots;
			for (int i = 3; i < 3 + maxAccessoryIndex; i++)
			{
				...
				if (!otherAccessory.IsAir &&
					...
					otherAccessory.modItem is Earrings)
				{
	...
	public class SlimeEarrings : Earrings
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Increase the max numbers of minions and turrets by 1 & summon damage by 10%.");
		}

		public override void UpdateAccessory(Player player, bool hideVisual)
		{
			// 0.50f = 50% damage increase
			player.minionDamage += 0.10f;
			player.maxMinions++;
			player.maxTurrets++;
		}

		public class ShieldEarrings : Earrings
		{
			public override void SetStaticDefaults()
			{
				Tooltip.SetDefault("Increase defense by 10, max life by 50 and life regeneration by 5.");
			}
		...
		public class SwordsEarrings : Earrings
		{
			public override void SetStaticDefaults()
			{
				Tooltip.SetDefault("Increase melee damage, crit chance and speed by 10%.");
			}
		...
		public class StarEarrings : Earrings
		{
			public override void SetStaticDefaults()
			{
				Tooltip.SetDefault("Increase magic damage & crit by 10% and max mana by 50.");
			}
		...
		public class FeathersEarrings : Earrings
		{
			public override void SetStaticDefaults()
			{
				Tooltip.SetDefault("Increase ranged damage, and crit  by 10% .");
			}
		...
		public class WeightedEarrings : Earrings
		{
			public override void SetStaticDefaults()
			{
				Tooltip.SetDefault("Increase thrown damage and crit by 10%.");
			}
