...
namespace TerraStory.Items.Weapons.Thief.BloodSlain
{
	[AutoloadEquip(EquipType.HandsOn)]
	internal class BloodSlain : ModItem
	{
		public override void SetStaticDefaults()
		{
			base.SetStaticDefaults();
			DisplayName.SetDefault("Blood Slain");
			Tooltip.SetDefault("transform your shurikens into bloody shurikens \n" +
				"which shatter into smaller shurikens and inflict 'Deep Cut'.");
		}
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			{
				type = ModContent.ProjectileType<BloodyShurikenP>();
			}
