...
{
	public class CorruptedSword : ModItem
	{

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Grim seeker Desperado");
			Tooltip.SetDefault("Shoots 3 desperados on your foes.");
		}
		public override void SetDefaults()
		{
			...
			item.shoot = mod.ProjectileType("CorruptedSwordP");
			item.melee = true;
			item.noMelee = true;
			item.autoReuse = true;
