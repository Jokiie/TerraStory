...
namespace TerraStory.Items.Armor.Thief
{
	...
	public class CrimsonGuise : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Red Guise");
			Tooltip.SetDefault("Set with the 'Red Stealer' overall.");
		}
		...
		{
			return body.type == ModContent.ItemType<RedStealer>();
		}
