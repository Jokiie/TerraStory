...
namespace TerraStory.Items.Armor.Thief
{
	...
	public class BlueLooseCap : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Blue Loosecap");
			Tooltip.SetDefault("Set with the 'Blue Pao' overall.");
		}
		...
		{
			return body.type == ModContent.ItemType<BluePao>();
		}
