...
namespace TerraStory.Items.Boss
{
	...
	public class OrangeMushmomDoll : ModItem
    {
		
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Orange Mushmom Doll");
		 ...
		 public override bool CanUseItem(Player player)
		{
		   ...
		   return !NPC.AnyNPCs(mod.NPCType("OrangeMushmom")) && Main.dayTime;
		 ...
		 public override bool UseItem(Player player)
		{
			...
			{
				NPC.SpawnOnPlayer(player.whoAmI, mod.NPCType("OrangeMushmom"));
			}
			return true;
		}
