...
namespace TerraStory.Items.Boss
{
	...
	public class TrueQueenBeeTreasureBag: ModItem
	{
		
		public override int BossBagNPC => mod.NPCType("TrueQueenBee");
		
		
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("True Queen bee's Treasure Bag");
