...
namespace TerraStory.Projectiles.Minions.CorruptedMors
{
	public class CorruptedMors : HoverShooter
	{
		...
		public override void SetDefaults()
		{
			...
			inertia = 20f;
			shoot = ProjectileType<CorruptedGhost>();
			shootSpeed = 12f;
