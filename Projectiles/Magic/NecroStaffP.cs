...
{
	public class NecroStaffP : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("NecroStaff projectile");
		}
		...
		public override void AI()
		{
			...
			int num = Projectile.NewProjectile(dustPosition, projectile.velocity, ProjectileType<MiniBones>(), 10, 0, default, 2f);
