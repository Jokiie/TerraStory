...
namespace TerraStory.Projectiles.Magic
{
    ...
    public class EnchantedTorchP : ModProjectile
	{
        ...
        public override void AI()
		{
			...
			Dust dust = Dust.NewDustPerfect(dustPosition, DustID.Fire, null, 100, Color.Lime, 0.8f);
			dust.velocity *= 0.3f;
			dust.noGravity = true;
		...
		public override void Kill(int timeLeft)
		{
			...
			for (int i = 0; i < 10; i++)
			{
				Dust dust = Dust.NewDustDirect(projectile.position - projectile.velocity, projectile.width, projectile.height, DustID.Fire, 0, 0, 100, default, 0.8f);
				dust.noGravity = true;
				dust.velocity *= 2f;
				dust = Dust.NewDustDirect(projectile.position - projectile.velocity, projectile.width, projectile.height, DustID.Fire, 0f, 0f, 100, default, 0.5f);
			}
		}
	}
}