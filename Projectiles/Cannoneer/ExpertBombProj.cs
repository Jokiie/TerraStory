...
{
	public class ExpertBombProj : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			ProjectileAnimations.Explode(projectile.whoAmI, 120, 120,
				delegate
				{
					for (int i = 0; i < 3; i++)
					{
						int num = Projectile.NewProjectile(projectile.position, projectile.velocity, ProjectileType<MinisExpertBombsProj>(), 15, 0, default, 2f);
