...
namespace TerraStory.Projectiles
{
    ...
    /// </summary>
    public class CrimsonItem : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Crimson ball");
        }
        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                int dust = Dust.NewDust(pos, w, h, DustID.Blood, 0f, 0f, projectile.alpha, default(Color), 1f);
            }
        }
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            for (int i = 0; i < 20; i++)
            {
                int dust = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, DustID.Blood, projectile.velocity.X * 0.1f, projectile.velocity.Y * 0.1f, 0, default(Color), 0.5f);
