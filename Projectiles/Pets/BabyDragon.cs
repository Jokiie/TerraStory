...
namespace TerraStory.Projectiles.Pets
{
    ...
    public class BabyDragon : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Summons a Baby Dragon!");
		}
		...
		public override void AI()
		{
			...
			{
				modPlayer.BabyDragon = false;
				//   Main.player[projectile.owner].truffle = false;
			}
			if (modPlayer.BabyDragon)
			{
...

			{
				...
				else
				{
					...
					float xAccelerationValue = 0.10f;
					float xVelocityLimit = 8f;
					if (playerOutOfRangeLeftSide)
					{
						...
						{
							projectile.velocity.X = projectile.velocity.X - xAccelerationValue * 0.35f;
						}
					}
