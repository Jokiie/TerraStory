...
{
	public class MapleArrow : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Maple Arrow");
		}
		...
		public override void Kill(int timeLeft)
		{
			...
			{
				int num159 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, ModContent.DustType<MapleDust>(), projectile.velocity.X * 0.1f, projectile.velocity.Y * 0.1f, 0, default(Color), 0.5f);
			...
			if (Main.myPlayer == projectile.owner)
			{
				...
				for (int num161 = 0; num161 < num160; num161++)
				{
					...
					Projectile.NewProjectile(projectile.oldPosition.X + projectile.width / 2, projectile.oldPosition.Y + projectile.height / 2, value12.X, value12.Y, ProjectileID.MolotovFire, (int)(projectile.damage * 0.8), projectile.knockBack * 0.8f, projectile.owner, 0f, 0f);
				}
			}
		}
		...
		public override void AI()
		{
			...
			if (projectile.localAI[0] > 3f)
			{
				...
				{
					int num92 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y + 2f), projectile.width, projectile.height, ModContent.DustType<MapleDust>(), projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.1f, 100, default(Color), 0.4f);
