...
{
	public class MapleThrowingStarP : ModProjectile
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Maple Throwing Star");
		...
		public override void Kill(int timeLeft)
		{
			...
			if (projectile.owner == Main.myPlayer)
			{
				...
				Main.rand.NextBool(18)
					? Item.NewItem(projectile.getRect(), ModContent.ItemType<MapleThrowingStar>())
					: 0;
		...
		{
			target.AddBuff(ModContent.BuffType<DeepCut>(), 240);
		}

		private const int MAX_TICKS = 55;
