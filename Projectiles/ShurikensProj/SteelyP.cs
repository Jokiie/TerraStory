...
{
	public class SteelyP : ModProjectile
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Steely Throwing Knife");
		...
		public override void Kill(int timeLeft)
		{
			...
			if (projectile.owner == Main.myPlayer)
			{
				...
				Main.rand.NextBool(18)
					? Item.NewItem(projectile.getRect(), ModContent.ItemType<Steely>())
					: 0;
		...
		{
			target.AddBuff(ModContent.BuffType<DeepCut>(), 120);
		}
