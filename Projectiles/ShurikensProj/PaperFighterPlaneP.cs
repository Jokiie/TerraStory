...
{
	public class PaperFighterPlaneP : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Paper Fighter Plane");
		...
		public override bool OnTileCollide(Vector2 oldVelocity)
		{
			...
			{
				SoundManager.PlaySound(Sounds.Grass, projectile.position);
				for (int num158 = 0; num158 < 20; num158++)
				{
					int num159 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 264, projectile.velocity.X * 0.1f, projectile.velocity.Y * 0.1f, 0, default(Color), 0.5f);
